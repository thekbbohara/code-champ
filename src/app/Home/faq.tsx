...
const FAQs = () => {
  ...
  return (<section className="flex flex-wrap lg:flex-nowrap mx-auto w-fit lg:max-w-[90vw] max-w-[500px]">
    ...
    <Accordion type="multiple" className="w-full  flex flex-col gap-4">
      {faqs.map(({ question, answer }, id) =>
        <AccordionItem value={`item-${id}`} key={id} className="flex flex-col gap-2">
          <AccordionTrigger className="font-semibold text-[18px] text-gray-300">{question}</AccordionTrigger>
